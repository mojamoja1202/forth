...
function add(){
  global $xoopsDB;
   $sql = "insert into " . $xoopsDB->prefix('forth_student') . " (`id`, `name`, `sex`, `year`, `month`, `day`, `school`, `class`, `phone`, `note`, `place`) values ('{$_POST['id']}','{$_POST['name']}','{$_POST['sex']}','{$_POST['year']}','{$_POST['month']}','{$_POST['day']}','{$_POST['school']}','{$_POST['class']}','{$_POST['phone']}','{$_POST['note']}','{$_POST['place']}')";
...
function update($sn){
  global $xoopsDB;
  $sql="update `" . $xoopsDB->prefix('forth_student') . "` set
  `id`    =   '{$_POST['id']}',
  `name`  =   '{$_POST['name']}',
  `sex`   =   '{$_POST['sex']}',
  `year`  =   '{$_POST['year']}',
